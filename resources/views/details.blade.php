        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__addtolinks">
            @if(Cart::instance('wishlist')->content()->where('id',$product->id)->count()>0)
               <form method="POST" id="remove-wishlist-form" action="{{route('wishlist.remove',['rowId'=>Cart::instance("wishlist")->content()->Where('id',$product->id)->first()->rowId])}}">
                    @csrf
                    @method("DELETE")
                    <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart" onclick="document.getElementById('remove-wishlist-form').submit();" ><svg width="16" height="16" viewBox="0 0 20 20"
          ...
          <div class="swiper-wrapper">
              ...
              <div class="pc__img-wrapper">
                <a href="{{ route('shop.product.details',['product_slug'=>$rproduct->slug]) }}">
                  <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $rproduct->image }}" width="330" height="400"
                    alt="{{ asset('uploads/products') }}/{{ $rproduct->name }}" class="pc__img">
            ...
            @endforeach
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{ route('shop.product.details',['product_slug'=>$product->slug]) }}">Zessi Dresses</a></h6>
                <div class="product-card__price d-flex">
